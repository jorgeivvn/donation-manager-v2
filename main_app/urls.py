...
from .views import logout_view, post_donate, remove_item_request, update_item_request
...
urlpatterns = [
    ...
    url(r'^update_item_request/$', update_item_request, name='update_item_request'),
